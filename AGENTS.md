# Kiswahili Kitabu cha Mwanafunzi Darasa la Tatu — ADT Bundle Reference
...
**Kiswahili Kitabu cha Mwanafunzi Darasa la Tatu** — Hiki ni kitabu cha mwanafunzi cha somo la Kiswahili kwa Darasa la Tatu kilichoandaliwa na Taasisi ya Elimu Tanzania, hivyo asili yake ni Tanzania na kimeandikwa kwa lugha ya Kiswahili. Kinalenga wanafunzi wa shule ya msingi wa kiwango cha chini, na kinashughulikia stadi kuu za lugha kama kusikiliza, kuzungumza, kusoma, kuandika, msamiati, matumizi ya kamusi, alama za uandishi, methali, nahau, vitendawili na usimulizi wa hadithi. Kitabu kinatumia hadithi, mashairi, mazungumzo, maigizo na mazoezi mengi ya ufahamu na utungaji ili kujenga umahiri wa mawasiliano kwa hatua, kwa mtazamo wa kujifunza kwa vitendo na kuhusisha maisha ya kila siku ya mwanafunzi.
...
├── KISWAHILI-DARASA-3--HR-.db                    # SQLite database (pipeline state)
├── KISWAHILI-DARASA-3--HR-.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg006_im001": "Msimbo wa QR wa kufungua maktaba mtandao kwa kujifunza zaidi.",
  "gl001": "abiria",
  "gl001_def": "mtu anayesafiri kwa gari, basi, treni, ndege au chombo kingine cha usafiri.",
  "qz001_que": "Nani alichaguliwa kuwa dada wa darasa?",
  "qz001_o0": "1) Ndwamila",
  "qz001_o0_exp": "✅ Hongera! Ndwamila ndiye alichaguliwa kuwa dada wa darasa."
}
```
...
```json
{
  "abiria": {
    "word": "abiria",
    "definition": "mtu anayesafiri kwa gari, basi, treni, ndege au chombo kingine cha usafiri.",
    "variations": ["wasafiri","abiria wote"],
    "emoji": "🚌👥"
  }
}
```
...
```json
{
  "title": "Kiswahili Kitabu cha Mwanafunzi Darasa la Tatu",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "sw",
...
<body>
    <div id="content" class="opacity-0">
        <section role="article" data-section-type="text_and_single_image"
            ...
            <img data-id="pg006_im001" src="images/pg006_im001.png" ...>
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">Nani alichaguliwa kuwa dada wa darasa?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="✅ Hongera! Ndwamila ndiye alichaguliwa kuwa dada wa darasa." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) Ndwamila</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `KISWAHILI-DARASA-3--HR-.pdf` |
| Pipeline database | `KISWAHILI-DARASA-3--HR-.db` (SQLite) |
